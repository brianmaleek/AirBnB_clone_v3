...
class DBStorage:
    ...
    def get(self, cls, id):
        """
        Query the current database session and return the object, or None if
        not found.
        """
        try:
    ...
    def count(self, cls=None):
        """
        Return the number of objects in storage matching the given class, or
        count all if cls is None.
        """
        try:
