...
## Python Back-end API Webserver Flask By: Guillaume, CTO at Holberton School
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/__init__.py](./api/__init__.py), [api/v1/__init__.py](./api/v1/__init__.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py), [api/v1/views/index.py](././api/v1/views/index.py), [api/v1/app.py](./api/v1/app.py)
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/v1/views/states.py](./api/v1/views/states.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py)
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/v1/views/cities.py](./api/v1/views/cities.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py)
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/v1/views/amenities.py](./api/v1/views/amenities.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py)
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/v1/views/users.py](./api/v1/views/users.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py)
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/v1/views/places.py](./api/v1/views/places.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py)
...
- GitHub repository: `AirBnB_clone_v3`
- File: [api/v1/views/places_reviews.py](./api/v1/views/places_reviews.py), [api/v1/views/__init__.py](./api/v1/views/__init__.py)
